...
- See the closest FFXIV dye with accuracy metrics
- Great for matching real-world colors to in-game dyes

### 2. Color Harmony Explorer
**"Show me dyes that look good together"**

- Select a starting dye
...
3. The app shows you:
   ...
   - **Color difference** (lower = closer match)
   - **Top 5 alternatives**
4. Click the **heart icon** to save to favorites
...
- Examples: "Tank Set", "House Furniture", "Healer Glamour"
- Maximum: 50 collections, 20 dyes each
...
- Check the Universalis price before committing!
