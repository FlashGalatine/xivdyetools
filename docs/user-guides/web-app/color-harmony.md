...
The Color Harmony Explorer uses color theory to suggest dyes that work beautifully together, helping you create coordinated outfits.
...
Enter your starting color using:
- **Hex code** (e.g., `#FF6B6B`)
- **Color picker**
...
Each harmony shows:
- **Color wheel visualization** - See the relationship
- **Matched dyes** - Actual FFXIV dyes for each position
- **Alternatives** - Other dyes that work in each slot
...
3. **Test in-game**: Colors may look slightly different on different gear
4. **Consider lighting**: Ul'dah vs Ishgard lighting affects perception

---

## Actions

For each suggested dye:
- **Add to Favorites** - Save for later
- **Compare** - Open in Dye Comparison
- **View Details** - See full dye information
