...
| 2026-09-18 | Documentation audit, `docs/` + the bot's `/manual` (37 findings: 1 HIGH, 25 MEDIUM; `/manual` was still the 4.x text in all six languages — fixed in PR #189) | [README.md](2026-09-18-documentation/README.md) |
