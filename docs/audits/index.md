...
| 2026-09-18 | Documentation audit, `docs/` + the bot's `/manual` (36 findings: 1 HIGH, 24 MEDIUM; `/manual` was still the 4.x text in all six languages) | [README.md](2026-09-18-documentation/README.md) |
