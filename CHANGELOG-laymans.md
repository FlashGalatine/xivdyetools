...
- Everywhere: 4K and ultrawide screenshots — the most common thing a player has to extract a palette from — were being refused before they were even read, on the website's Palette Extractor and the bot's `/extractor image` alike. They work now.
- Web app: the colour palette's category headings (Whites, Reds, Blues…) and the entire Community Presets flow were stuck in English for every language. Both are translated now, and screens update the moment you switch language.
