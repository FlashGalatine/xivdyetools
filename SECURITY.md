...
- Periodic whole-monorepo audits with every finding tracked to closure (`docs/audits/`; the
  latest *security* audit is `docs/audits/2026-08-29-security/`, and later dated directories
  there cover other kinds of audit).
