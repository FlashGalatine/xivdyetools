 ...
 * @public — published because it is part of the `.d.ts` contract; `@internal`
 * above is a narrower, separate note that consumers should not import it
 * directly, not a contradiction of this tag.
 */
