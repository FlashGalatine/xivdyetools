...
|-----|---------|-------------|
| [`web-app`](apps/web-app/) | 5.12.0 | Main web app at [xivdyetools.app](https://xivdyetools.app) (Vite + Lit + Tailwind) |
| [`discord-worker`](apps/discord-worker/) | 5.6.0 | Primary Discord bot — 17 slash commands (CF Worker + Hono, HTTP Interactions) |
...
| [`api-worker`](apps/api-worker/) | 0.14.4 | Public REST API at [data.xivdyetools.app](https://data.xivdyetools.app) + Universalis proxy routes + docs site at [developers.xivdyetools.app](https://developers.xivdyetools.app) (CF Worker + KV) |
