...
| [`@xivdyetools/bot-logic`](packages/bot-logic/) | 4.3.0 | Platform-agnostic command business logic + bot UI translation engine (`/i18n`) |
...
| [`discord-worker`](apps/discord-worker/) | 5.5.8 | Primary Discord bot — 17 slash commands (CF Worker + Hono, HTTP Interactions) |
...
| [`api-worker`](apps/api-worker/) | 0.14.3 | Public REST API at [data.xivdyetools.app](https://data.xivdyetools.app) + Universalis proxy routes + docs site at [developers.xivdyetools.app](https://developers.xivdyetools.app) (CF Worker + KV) |
