...
| [`discord-worker`](apps/discord-worker/) | 5.5.2 | Primary Discord bot — 17 slash commands (CF Worker + Hono, HTTP Interactions) |
...
| [`presets-api`](apps/presets-api/) | 2.3.1 | Community presets REST API + preview-image storage (CF Worker + D1 + R2) |
