...
export const OG_EMBED: Record<LocaleCode, Record<EmbedKey, string>> = {
  ...
  de: {
    ...
    'harmony.description': 'Erkunde {harmony}-Farbharmonien für {dye} ({hex}) in FFXIV. Finde passende Farbstoffe für deine Projektion!',
    ...
    'gradient.description': 'Verlauf in {n} Stufen von {start} ({startHex}) zu {end} ({endHex}). Finde die perfekte Farbstoff-Abfolge für deine FFXIV-Projektion!',
    ...
    'accessibility.title': '{lens}: {names}',
    'accessibility.description': 'Sieh, wie {names} bei {lens} erscheinen. Gestalte Projektionen für alle!',
    ...
    'root.description': 'Erkunde FFXIV-Farbstoffe, erstelle harmonische Paletten, baue Verläufe, mische Farben und finde die perfekte Kombination für deine Projektion. Kostenlose Web-Tools für Final-Fantasy-XIV-Spieler.',
    'unknown.description': 'Erkunde FFXIV-Farbstoffe, erstelle harmonische Paletten und finde die perfekte Kombination für deine Projektion.',
  ...
  ko: {
    ...
    'harmony.description': 'FFXIV의 {dye}({hex})를 중심으로 한 {harmony} 색상 조화. 코디에 어울리는 염료를 찾아보세요!',
    'harmony.titleNoDye': '{harmony} 조화',
    'harmony.descriptionNoDye': 'FFXIV 염료로 {harmony} 색상 조화를 탐색하세요.',
    'gradient.title': '{start}에서 {end}까지 그라데이션',
    'gradient.description': '{start}({startHex})에서 {end}({endHex})까지 {n}단계 그라데이션. FFXIV 코디에 딱 맞는 염료 흐름을 찾아보세요!',
    ...
    'accessibility.title': '{lens}: {names}',
    'accessibility.description': '{lens}에서 {names}이(가) 어떻게 보이는지 확인하세요. 모두를 위한 코디를 디자인하세요!',
    ...
    'budget.description': '{dye}({hex})에 가까운 더 저렴한 FFXIV 염료 — 색상 거리순 정렬, 장터 가격 기준.',
    'budget.descriptionDefault': '원하는 색에 가까운 가장 저렴한 FFXIV 염료 — 장터 가격 기준.',
    'root.title': 'XIV Dye Tools - FFXIV 색상 & 염료 도우미',
    'root.description': 'FFXIV 염료 색상을 탐색하고, 조화로운 팔레트와 그라데이션, 혼합색을 만들고, 완벽한 코디 조합을 찾아보세요. 파이널 판타지 XIV 플레이어를 위한 무료 웹 도구.',
    'unknown.description': 'FFXIV 염료 색상을 탐색하고, 조화로운 팔레트를 만들고, 완벽한 코디 조합을 찾아보세요.',
