 ...
 * logger.info('Processing interaction', { interactionId: interaction.id });
 * ```
 */
export async function loggerMiddleware(
  ...
  // Discord worker doesn't have an explicit ENVIRONMENT var
  // Default to 'production' for log level purposes
