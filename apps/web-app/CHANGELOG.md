...
The 2026-08-20 i18n audit (`docs/audits/2026-08-20-web-app-i18n/`) found ≈270 hardcoded-English rows across the nine tools, one outright bug, and a 58-cell vocabulary split with core — this remediation closes all of it. Locale files grow from 1,075 to 1,153 keys per language (all six re-validated for structure, key order and value parity); no core package changed.
