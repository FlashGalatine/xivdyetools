 ...
 * audit, WEB-9). The copy is deliberately plain English: LanguageService may
 * be the very thing that failed to initialise.
 *
...
export function renderFatalError(
  ...
  lead.textContent = 'Failed to initialize XIV Dye Tools';
